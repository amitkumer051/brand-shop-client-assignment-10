...
const Banner = () => {
    return (
        <div className="hero mb-14 lg:h-[500px] md:h-[700px] h-[800px]" style={{ backgroundImage: 'url(https://i.ibb.co/6gFnr9B/banner12.jpg)' }}>
            <div className="hero-overlay w-auto bg-opacity-60"></div>
            <div className=" text-center text-white lg:flex items-center">
                ...
                <div className="lg:w-1/2  ">
                    <div className="carousel carousel-center md:w-96 w-64 p-4 space-x-4 bg-neutral rounded-box">
